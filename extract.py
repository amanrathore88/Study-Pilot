...
def extract_syllabus(text):
    promt = f"""
           You are a structure data explorer.
           Extract Only syllabus units.
           Each units should become one JSON object.

           Do NOT create a separate objects for the list of all units.
           Do NOT treat unit names as chapters.
           The chapters field should contain only the topics listed under units.
