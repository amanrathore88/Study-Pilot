...
def calculate_priority(subject, today=None):
    ...
    # prase the weightage
    try:
        weightage = float(weightage_str.strip('%', "").strip())
    except:
        weightage = 10.0
    ...
    if exam_date_str:
        ...
        days_remaining = 30  # Default to 30 days if no exam date is provided
...
def allocate_hours(subjects, daily_hours=4):
    ...
    for subject in subjects:
        ...
        scored.append({
            ...
            "weightage": subject.get("weightage", "Not specified"),
    ...
    # Allocate mintues proportionally
